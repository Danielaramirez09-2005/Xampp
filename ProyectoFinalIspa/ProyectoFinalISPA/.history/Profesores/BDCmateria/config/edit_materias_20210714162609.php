                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <form action="../config/actualizar.php" method="POST">
                            <div class="form-group">
                                ...
                                <input value="<?= $idMateria?>" type="text" class="form-control" id="nombre" name="id" aria-describedby="id">
                                <label for="id">Nombre</label>
                                <input value="<?= $nomMateria?>" class="form-control" name="nombre" id="userId" aria-describedby="idHelp" require>
                              </div>

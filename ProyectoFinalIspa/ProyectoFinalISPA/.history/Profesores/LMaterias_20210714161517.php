...
<body class="color-background">
  ...
  <nav class="navbar navbar-light bg-light">
    ...
    <div class="dropdown">
      <a class="btn btn-ligth dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Estudiantes</a>
    ...
    <div class="dropdown ml-auto">
      <a class="btn btn-ligth dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Usuario</a>
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      ...
      <div class="card">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="btn btn-sm">
            <a class="list-group-item list-group-item-action active " id="list-Crear-materia-list" href="./BDCmateria/index.php">Crear Materia</a>
          </div>
        </div>
      </div>
      <div class="card-body">
